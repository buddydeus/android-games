...
- Brand block: existing circular package Logo, exact title `军棋`, exact version `版本 0.0.9`.
...
Text (verbatim): "军棋", "版本 0.0.9", "单人模式", "双人对战", "退出游戏".
