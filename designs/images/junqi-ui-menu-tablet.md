...
- Brand block: existing circular package Logo, exact title `军棋`, exact version `版本 0.0.10`.
...
Subject: The runtime source's complete empty 12-by-5 Junqi board fills the left board pane and preserves its 1400:1680 aspect ratio. Preserve every road and rail connection. Restyle it after the classic reference: low-saturation straw-gold fiberboard, thin dark-ink road lines, highly legible alternating dark-and-ivory railway sleepers, rectangular stations labeled "兵站", oval camps labeled "行营", rectangular headquarters labeled in red "大本营", and three separate striped center bridges. Do not add pieces. Use the Xiangqi reference outer geometry with 28dp page padding, a 34dp board/rail gap, and a 320dp menu rail at 88 percent content height. On the right is a flat unframed order rail with the existing round red-versus-blue Junqi Logo, large exact Chinese title "军棋", exact smaller text "版本 0.0.10", and three large buttons with exact labels "单人模式", "双人对战", "退出游戏".
...
Text (verbatim): "军棋", "版本 0.0.10", "单人模式", "双人对战", "退出游戏".
