...
- Score/status rail: family-standard three-zone rail with exact Chinese labels `玩家 : 智能`, `0 : 0`, `智能等级 1`, `当前回合：绿方`, `最近一步吃子`, `红方鼠`; two horizontal dividers separate score, turn/capture summary and actions. Never show `松绿`, `朱砂`, or `玩家执`.
...
Text (verbatim): "象", "狮", "虎", "豹", "狼", "狗", "猫", "鼠", "玩家 : 智能", "0 : 0", "智能等级 1", "当前回合：绿方", "最近一步吃子", "红方鼠", "悔棋", "返回菜单".
...
Avoid: the words "松绿", "朱砂", or "玩家执"; dark esports HUD, neon, photorealistic animals, cute cartoons, jungle wallpaper, glass cards, clutter, emojis, English text, watermark, device frame, screenshot-cropped static board.
