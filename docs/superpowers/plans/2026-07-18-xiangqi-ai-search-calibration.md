...
- [ ] **Step 1: Write failing conversion and make/unmake tests**
...
- [ ] **Step 3: Implement primitive encoding, conversion, and reversible moves**
...
- [ ] **Step 4: Write randomized legal-move equivalence tests**
...
- [ ] **Step 5: Implement direct legal generation and check detection**
...
- [ ] **Step 6: Run search-position and existing rule tests**
...
- [ ] **Step 1: Write failing search-statistics tests**
...
- [ ] **Step 3: Implement search results, limits, and compatibility wrapper**
...
- [ ] **Step 4: Write a failing leaf-work regression**
...
- [ ] **Step 5: Implement reusable ply buffers and cached ordering scores**
...
- [ ] **Step 1: Write failing evaluation-equivalence and tactical tests**
...
- [ ] **Step 3: Implement direct evaluation and bounded quiescence**
...
- [ ] **Step 4: Write failing transposition-table tests**
...
- [ ] **Step 5: Implement a fixed-size primitive transposition table**
...
- [ ] **Step 6: Run the complete Xiangqi unit suite**
...
- [ ] **Step 1: Write a failing compact depth-ladder test**
...
- [ ] **Step 3: Recalibrate immutable level configurations**
...
- [ ] **Step 4: Implement the opt-in color-swapped match harness**
...
- [ ] **Step 5: Run compact calibration and the long release calibration**

Run:

```bash
./gradlew :games:xiangqi:testDebugUnitTest --tests com.buddygames.xiangqi.XiangqiAiCalibrationTest
./gradlew :games:xiangqi:testDebugUnitTest --tests com.buddygames.xiangqi.XiangqiAiCalibrationTest -Dxiangqi.calibration=true
```

Expected: every adjacent higher level scores 65% to 75% across at least 100
color-swapped games, every two-level gap scores at least 80%, and no adjacent
pair exceeds 80% identical moves in the fixed-position corpus.

- [ ] **Step 6: Record final parameters and calibration evidence**
...
- [ ] **Step 3: Update package versions and repository instructions**
...
- [ ] **Step 5: Review and create a scoped local commit**
