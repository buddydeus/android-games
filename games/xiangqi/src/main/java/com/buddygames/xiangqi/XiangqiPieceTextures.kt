...
internal const val XIANGQI_BOARD_TEXTURE_WIDTH = 1440
internal const val XIANGQI_BOARD_TEXTURE_HEIGHT = 1600
internal const val XIANGQI_BOARD_ASPECT_RATIO = 0.90f
internal const val XIANGQI_GRID_LEFT_FRACTION = 192f / XIANGQI_BOARD_TEXTURE_WIDTH
internal const val XIANGQI_GRID_TOP_FRACTION = 190f / XIANGQI_BOARD_TEXTURE_HEIGHT
internal const val XIANGQI_GRID_RIGHT_FRACTION = 1248f / XIANGQI_BOARD_TEXTURE_WIDTH
internal const val XIANGQI_GRID_BOTTOM_FRACTION = 1378f / XIANGQI_BOARD_TEXTURE_HEIGHT
internal const val XIANGQI_PIECE_TEXTURE_SCALE = 0.78f
