...
internal const val XIANGQI_GRID_TOP_FRACTION = 110f / XIANGQI_BOARD_TEXTURE_HEIGHT
internal const val XIANGQI_GRID_RIGHT_FRACTION = 1472f / XIANGQI_BOARD_TEXTURE_WIDTH
internal const val XIANGQI_GRID_BOTTOM_FRACTION = 1360f / XIANGQI_BOARD_TEXTURE_HEIGHT
internal const val XIANGQI_PIECE_TEXTURE_SCALE = 0.80f
