...
internal object ChessAiGradient {
    private val configs = listOf(
        ...
        ChessAiLevelConfig(2, 2, 6_000, 120, 5, 45, ChessEvaluationProfile.MATERIAL, 0),
        ChessAiLevelConfig(3, 3, 18_000, 220, 4, 30, ChessEvaluationProfile.PIECE_SQUARE, 0),
        ChessAiLevelConfig(4, 3, 45_000, 350, 3, 15, ChessEvaluationProfile.PIECE_SQUARE, 1),
        ChessAiLevelConfig(5, 4, 100_000, 550, 1, 0, ChessEvaluationProfile.ACTIVITY, 1),
        ChessAiLevelConfig(6, 5, 220_000, 850, 1, 0, ChessEvaluationProfile.ACTIVITY, 1),
