...
| [docs/superpowers/reports/2026-07-28-doushouqi-two-player-immediate-capture-summary-runtime-acceptance.md](docs/superpowers/reports/2026-07-28-doushouqi-two-player-immediate-capture-summary-runtime-acceptance.md) | Android 36 evidence that a two-player capture publishes immediately and the following quiet move clears it |
