...
- International Chess uses standard square placement, complete special moves and draw rules, player-score-driven 1-10 offline search, explicit draw session state, Xiangqi-family score/undo/restart behavior, and a 180-degree Black-player view with upright piece glyphs. Its right rail distinguishes the active side, check, terminal result, AI level, undo, and restart.
