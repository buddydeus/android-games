...
The Dou Shou Qi module owns its immutable 7x9 initial board, orthogonal movement, Rat-only river access, Rat-blocked Lion/Tiger jumps, rank captures, Rat/Elephant exception, terrain-bound Rat captures, trap weakening, immutable move application, and the exact den/final-capture/no-move/repetition/100-quiet terminal precedence. Its local rule variants allow both sides to enter, occupy, and leave their own den without winning, and make a defender in any trap capturable by any enemy animal regardless of trap ownership or normal rank, including Elephant-versus-Rat; a trapped attacker leaving uses normal rank. Keep public rules, primitive search, and AI trap-risk evaluation equivalent while opponent-den entry remains terminal. Keep these rules and their board/movement/capture/state/terminal tests together in `games/doushouqi/`.
...
| [docs/superpowers/specs/2026-07-31-doushouqi-universal-trap-capture-design.md](docs/superpowers/specs/2026-07-31-doushouqi-universal-trap-capture-design.md) | Approved local rule variant making every trapped defender capturable by any enemy animal regardless of trap ownership |
| [docs/superpowers/plans/2026-07-31-doushouqi-universal-trap-capture.md](docs/superpowers/plans/2026-07-31-doushouqi-universal-trap-capture.md) | TDD plan for universal trap capture, AI risk alignment, Doushouqi 0.0.9 release, and verification |
