...
- Junqi Task 2 owns the approved immutable 12x5 board graph and legal movement foundation: keep all 60 nodes, road/rail adjacency, camps, headquarters, engineer railway turns, straight-only non-engineer railway movement, occupied-camp attack protection, and immobility rules inside `games/junqi/`.
